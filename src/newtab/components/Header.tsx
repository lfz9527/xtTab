      ...
      <div className='flex items-center justify-between gap-2 p-2 pl-3 pr-4'>
        <div className='flex items-center gap-2'>
          <button
            type='button'
            aria-label='快捷书签'
            onClick={() => setActiveHeaderView('pins')}
            className={`flex size-9 cursor-pointer items-center justify-center rounded-full transition-colors hover:bg-muted hover:text-foreground ${activeHeaderView === 'pins' ? 'bg-muted text-foreground' : 'text-muted-foreground'}`}
          >
